...
$.ajax({
  ...
  data: {
    key: 'SL3BZ-VQUWN-PNSFO-SV4ZF-WRG6O-ZUFTF',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(116.358101, 39.961597, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 陈平安🥝 %c 你正在访问陈平安🥝の小家",
...
// 设置重复执行函数，周期1000ms src='https://lskypro.acozycotage.net/Fomalhaut/badge/F小屋-科研摸鱼中.svg'
setInterval(() => {
  createtime();
}, 1000);
